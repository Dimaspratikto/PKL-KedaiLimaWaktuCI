        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    <div class="row"> <img src="<?php echo base_url()?>asset/layout/assets/img/k5w.png" class="img-fluid" style="margin-top: 20px;
	margin-left: 35px;"> </div>
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    ...
                    <form method="post" action="<?=base_url('index.php/llogin/login_aksi');?>">
                    
                    
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Username</h6>
                        </label> <input class="mb-4" type="text" name="username" placeholder="Silahkan Masukan Username"> </div>
                        <small><span class="text-danger"><?= form_error('username'); ?></span></small>
                    <div class="row px-3"> <label class="mb-1">
                            <h6 class="mb-0 text-sm">Password</h6>
                        </label> <input type="password" name="password" placeholder="Silahkan Masukan Password"> </div>
                    ...
                    <button type="button" class="btn btn-primary btn-md text-center" value="Go Back" onclick="history.back(-1)" />Back</button>
                    </div> -->
                    <div class="row px-3">
                    <label class="mb-1"></label>
                    <button type="submit" class="btn btn-primary btn-md text-center">Login</button> 
                    </div>
        ...
        <div class="bg-blue py-4">
            <div class="row px-3"> <small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2021-2025. Kerja Praktek ITATS 2021.</small>
